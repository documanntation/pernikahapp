...
export default function App() {
  ...
  const filteredResources = resources.filter((res) => {
    ...
    const matchesMediaType =
      selectedMediaType === "all" || res.resourceType === selectedMediaType;
    const matchesSearch =
        ...
        <AnimatePresence mode="wait">
          ...
          {currentTab === "home" && (
            ...
            >
              ...
              <div
                id="catalog-anchor"
                className="scroll-mt-24 grid grid-cols-1 lg:grid-cols-12 gap-8 pt-4"
              >
                  ...
                  <div className="bg-[#f5f3ef] border border-brand-beige-dark/50 rounded-2xl p-4 sticky top-28">
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        ...
                        <span
                          className={`text-[9px] px-1.5 py-0.5 rounded-full font-mono font-bold ${selectedCategory === "all" ? "bg-white/20" : "bg-brand-sky text-zinc-600"}`}
                        >
                          {resources.length}
                        </span>
                      </button>
                      ...
                      {PHASES.map((phase) => {
                        const phaseCats = CATEGORIES.filter(
                          (cat) => cat.phaseId === phase.id,
                        );
                        return (
                          <div
                            key={phase.id}
                            className="space-y-1.5 pt-2 border-t border-brand-beige-dark/20"
                          >
                              ...
                              {phaseCats.map((cat) => {
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <span
                                      className={`text-[10px] px-1.5 py-0.5 rounded-full font-bold font-mono ${selectedCategory === cat.id ? "bg-white/20" : "bg-brand-sky text-zinc-600"}`}
                                    >
                                      {count}
                                    </span>
                                  </button>
                ...
                <div className="lg:col-span-9 space-y-6">
                  ...
                  <div className="bg-brand-sky border border-brand-beige-dark/45 px-4 py-3 rounded-xl text-xs flex items-center justify-between">
                    <div>
                      <span className="font-bold text-brand-slate uppercase">
                        {t("activeFilterLabel")}
                      </span>
                    ...
                    <span className="text-[#6b7280] font-bold font-mono text-[10px]">
                      {t("matsFound").replace(
                        "{count}",
                        String(filteredResources.length),
                      )}
                    </span>
                  </div>
                  ...
                  {isLoading ? (
                    <div className="py-24 text-center">
                      ...
                      <p className="text-xs font-extrabold text-[#9ca3af] uppercase tracking-wider">
                        {t("loading")}
                      </p>
                    </div>
                    ...
                    <div className="py-20 border-2 border-dashed border-[#eae7e1] rounded-3xl text-center">
                      ...
                      <p className="text-sm font-bold text-brand-slate mb-1">
                        {t("matsNotFound")}
                      </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-8 border-b border-zinc-800">
            ...
            <div>
              <div className="flex items-baseline space-x-1 mb-3">
                <span className="serif-heading text-xl font-bold text-white tracking-wide">
                  {t("appName")}
                </span>
                <span className="script-accent text-2xl text-brand-blue font-medium leading-none">
                  {t("appSubtitle")}
                </span>
              </div>
              ...
              <ul className="text-xs space-y-2">
                <li>
                  <button
                    ...
                    className="hover:text-[#4682b4] transition cursor-pointer"
                  >
                    {t("footerQuickLibrary")}
                  </button>
                </li>
                <li>
                  <button
